...
6. `coral_reef_scene`: Combines all elements into a complete scene

The scene features:
- Multiple clusters of branching corals with organic curves
- Schools of fish swimming in circular patterns at different heights
- A rocky base foundation
- Various colors and sizes to create visual interest
- Randomized elements to create natural variation

The scene is organized in layers with rocks at the bottom, corals growing from the rocks, and fish swimming above in schools. The randomization in positions and sizes creates a more natural, organic look.
"""